...
var _index = _interopRequireDefault(__webpack_require__(329));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _index.default)(200).then(function (_) {
...
function delay(_time) {
  return new Promise(function (resolve, reject) {
    if (_time === undefined || _time === null) reject(new Error("Argument _time missed"));
    if (typeof _time !== "number") reject(new TypeError("Argument _time must be a Number"));
    var time = parseInt(_time, 10);
